...
interface AuthContextType {
  ...
  updateNegocio: (updates: Partial<Pick<Negocio, "nombre" | "direccion" | "telefono" | "email" | "waha_url" | "waha_api_key" | "owner_phone" | "owner_access_key">>) => Promise<{ error: Error | null }>
}
...
export function AuthProvider({ children }: { children: ReactNode }) {
  ...
  const updateNegocio = async (
    updates: Partial<Pick<Negocio, "nombre" | "direccion" | "telefono" | "email" | "waha_url" | "waha_api_key" | "owner_phone" | "owner_access_key">>
  ) => {
